...
export function VoiceCheckIn() {
  ...
  return (
    <div className="mt-16 flex w-full max-w-xl flex-col items-center">
      <button
        type="button"
        onClick={start}
        disabled={active}
        className="flex size-[19.5rem] flex-col items-center justify-center gap-3 rounded-full bg-blue p-8 transition-transform active:scale-95 disabled:cursor-wait disabled:active:scale-100"
      >
