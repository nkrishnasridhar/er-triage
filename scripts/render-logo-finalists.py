...
def create(which,title,description):
    ...
    svg=f'''<svg xmlns="http://www.w3.org/2000/svg" width="1500" height="500" viewBox="0 0 1500 500" role="img" aria-labelledby="title desc"><title id="title">ERgency — {title}</title><desc id="desc">{description}</desc><rect width="1500" height="500" fill="{PAPER}"/><g transform="translate(100 165) scale(1.85)">{inner}</g><text x="310" y="258" fill="{INK}" font-family="Inter,Arial,sans-serif" font-size="78" font-weight="600" letter-spacing="-2">ERgency</text></svg>'''
    ...
    d.text((310,174),"ERgency",font=font(78),fill=INK)
...
d.text((48,26),"ERGENCY  /  TWO PREFERRED LOGO DIRECTIONS",font=font(24,True),fill=INK)
