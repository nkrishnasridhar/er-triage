...
It does not diagnose, prescribe, assign an Australasian Triage Scale category, set a clinician's priority, decide who is seen, or determine disposition. It can present a source-linked starting order for report review; every report remains openable and model output is not clinical truth.
